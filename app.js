(function () {
  const STORAGE_KEY = "simple_time_tracker_entries_kid_v2";
  ...
  function parseTimeToMinutes(timeStr, ampm) {
    ...
    const match = cleaned.match(/^([0-9]{1,2})(?::([0-9]{1,2}))?$/);
  ...
  form.addEventListener("submit", (e) => {
    ...
    const endAmpmVal = endAmpm.value;
    ...
    const endMinutes = parseTimeToMinutes(endTimeStr, endAmpmVal);
    if (endMinutes == null) {
      alert("Please enter a valid end time like 3:00 or 10:15.");
      return;
    }
